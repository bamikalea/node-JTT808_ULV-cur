...
module.exports = {
  ...
  auth: {
    ...
    allowedTerminals: process.env.ALLOWED_TERMINALS ? process.env.ALLOWED_TERMINALS.split(',').map(id => parseInt(id)) : [12345678, 87654321, 11111111, 22222222, 628076842334],
  ...
  security: {
    ...
    rateLimit: {
      ...
      maxMessagesPerSecond: parseInt(process.env.MAX_MESSAGES_PER_SECOND) || 100,
